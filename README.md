...
1. **Клонируйте репозиторий:**
   ```bash
   git clone https://github.com/semonoff/rh_editor.git
   cd rh_editor
   ```
...
```
rh_editor/
├── mh_editor.py          # Main application
├── utils/
│   ├── ecs7tags2equips.py # ECS7 tag converter
│   ├── ecs8tags2equips.py # ECS8 tag converter
│   └── exceptions.py      # Custom exceptions
├── resources/
│   └── icon.ico          # Application icon
├── equips.json           # Equipment configuration
├── plc.json             # PLC configuration
