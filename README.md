...
- **v1.2.1** (2026-03-21) - Текущая версия
  - Увеличен лимит часов техобслуживания до 50 000
  - Добавлены новые утилиты конвертации (MDB, SQLite, WinCC)
  - Добавлена утилита merge_equips для объединения конфигураций
